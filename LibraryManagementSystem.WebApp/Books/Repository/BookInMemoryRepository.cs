...
{
    public class BookInMemoryRepository(IMapper mapper) : IBookInMemoryRepository
    {
        private static readonly List<Book> _books;

        static BookInMemoryRepository()
        {
            _books = new List<Book>
            {
                new Book { Id = 1, Title = "Korkma Ben Varım",
                    Author = new Author{ Name="Murat Mentaş"},
                ...
                new Book { Id = 2, Title = "Kan,Ter ve Pikseller",
                    Author = new Author{ Name="Jason Scharer"},
                ...
                new Book { Id = 3, Title = "Son Dilek (The Witcher)",
                    Author = new Author{ Name="Andrzej Sapkowski"},
